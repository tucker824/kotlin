...
class CompoundResolver(private val resolvers: List<GenericResolver>) : GenericRepositoryWithBridge {

    constructor(vararg resolvers: GenericResolver) : this(resolvers.toList())
