...
internal class FirResolvedQualifierImpl(
    ...
    override var resolveToCompanionObject: Boolean = (symbol?.fir as? FirRegularClass)?.companionObject != null
    ...
    override fun replaceResolveToCompanionObject(newResolveToCompanionObject: Boolean) {
        resolveToCompanionObject = newResolveToCompanionObject
    }
