...
sealed class ExhaustivenessStatus {
     ...
     */
    object TriviallyExhaustive : ExhaustivenessStatus()
...
val FirWhenExpression.isExhaustive: Boolean
    get() = exhaustivenessStatus == ExhaustivenessStatus.ProperlyExhaustive || exhaustivenessStatus == ExhaustivenessStatus.TriviallyExhaustive
