...
sealed class FirClassSymbol<C>(classId: ClassId) : FirClassLikeSymbol<C>(classId) where C : FirClass<C> {
...
class FirAnonymousObjectSymbol : FirClassSymbol<FirAnonymousObject>(ClassId(FqName.ROOT, FqName.ROOT, true))
